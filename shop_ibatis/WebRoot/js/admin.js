...
function getuserInfo(id){
	wizwindow(contextPath+'/admin/member/memberView.popup?id='+id, 'regisform','width=650,height=650,statusbar=no,scrollbars=yes,toolbar=no');
}
...
function openorderwindow(tid){	
	wizwindow(contextPath+'/admin/order/orderView.popup?tid='+tid, 'cartform','width=620,height=700,statusbar=no,scrollbars=yes,toolbar=no')
}
